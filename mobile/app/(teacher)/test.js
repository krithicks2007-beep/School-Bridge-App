        ...
        {loading ? (
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
            ...
            <View className="bg-gray-50 rounded-2xl p-4 border border-gray-100 mb-5">
              ...
              <View className="flex-row items-center bg-white border border-gray-200 rounded-xl px-4 py-3 shadow-sm shadow-gray-200/50 mb-4">
              ...
              <Text className="text-sm font-semibold text-gray-700 mb-1.5">Test Name</Text>
              <TextInput
              ...
              <View className="flex-row space-x-3">
                <View className="flex-1">
                  <Text className="text-sm font-semibold text-gray-700 mb-1.5">Total Marks</Text>
                  <TextInput
                    placeholder="100"
                ...
                <View className="flex-1">
                  ...
                  <View className="flex-row items-center bg-white border border-gray-200 rounded-xl px-4 py-3 shadow-sm shadow-gray-200/50">
                    <Ionicons name="calendar-outline" size={16} color="#6B7280" />
                    <Text className="ml-2 text-gray-700 font-medium text-sm">{new Date().toLocaleDateString('en-GB', { day: 'numeric', month: 'short', year: 'numeric' })}</Text>
                  </View>
                </View>
              </View>
            </View>
            ...
            {/* Submit Button */}
            {currentStudents.length > 0 && (
              <TouchableOpacity className="w-full bg-indigo-600 py-4 rounded-2xl shadow-lg shadow-indigo-600/40 items-center flex-row justify-center mt-4">
                <Ionicons name="checkmark-circle" size={20} color="white" />
                <Text className="text-white font-bold text-lg ml-2">Submit Marks</Text>
              </TouchableOpacity>
            )}
          </ScrollView>
        )}
